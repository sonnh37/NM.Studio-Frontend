...
export function SidebarProduct() {
  ...
  //     queryFn: async () => {
  //         const query: ColorGetAllQuery = {
  //             pagination: {
  //                 isPagingEnabled: false,
  //             },
  //             isDeleted: false,
  //         };
  //         const response = await colorService.getAll(query);
  ...
  //     queryKey: ["fetchSizes"],
  //     queryFn: async () => {
  //         const query: SizeGetAllQuery = {
  //             pagination: {
  //                 isPagingEnabled: false,
  //             },
  //             isDeleted: false,
  //         };
  //         const response = await sizeService.getAll(query);
  ...
  const allDataLoaded =
    // !colorsLoading &&
    // !sizesLoading &&
    !categoriesLoading && !selectedCategoryLoading;
