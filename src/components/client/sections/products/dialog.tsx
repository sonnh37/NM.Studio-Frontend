    ...
    return (
        ...
        >
            ...
            <div className="fixed inset-0 z-[1001] w-screen overflow-y-auto">
                <div
                    className="flex min-h-full items-stretch justify-center text-center md:items-center p-0 m-0 border-none">
                    <DialogPanel
                        transition
                    ...
                    >
                        <div className="relative flex w-full items-center overflow-hidden bg-white p-0 shadow-2xl">
                            ...
                            <div className="grid w-full grid-cols-1 items-start sm:grid-cols-12">
                                <div
                                    className="aspect-[2/3] p-0 w-full rounded-none border-none bg-gray-100 object-cover sm:col-span-6">
                                    <Carousel className="w-full">
                                            ...
                                            {product.productXPhotos?.map((pic, index) => (
                                                <CarouselItem key={index}>
                                                    <Card className="border-none">
                                                        <CardContent
                                                            className="flex aspect-square p-0 m-0 border-none items-center justify-center">
                                                            <Image
                                        ...
                                        <CarouselPrevious
                                            className="absolute left-2 top-1/2 -translate-y-1/2 p-2 bg-neutral-100 bg-opacity-40 rounded-lg border-none shadow-lg z-10"/>
                                        <CarouselNext
                                            className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-neutral-100 bg-opacity-40 rounded-lg border-none shadow-lg z-10"/>
                                    </Carousel>
                                </div>
                                {/* <img
