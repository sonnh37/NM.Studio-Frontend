...
import {FormInput, FormInputDateTimePickerV2, FormSelectObject,} from "@/lib/form-custom-shadcn";
                        ...
                        <div className="mx-auto w-full">
                            <div className="grid gap-1">
                                <div className="flex justify-start gap-3">
                                    <FormInputDateTimePickerV2 label={"Ngày hẹn"} name={"bookingDate"} form={form}/>
