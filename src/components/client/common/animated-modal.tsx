...
export function BookingModal() {
    ...
    return (
        <div className="py-5 flex items-center justify-center">
          ...
          <span
              className="group-hover/modal-btn:translate-x-40 text-primary-foreground text-center transition duration-500">
            Liên hệ tư vấn
          </span>
                    <div
                ...
                NMS
                  ...
                  Tâm huyết
                            ...
                            <div className="flex items-center justify-center">
                                ...
                                <span className="text-neutral-700 dark:text-neutral-300 text-sm">
                  Sẵn sàng tư vấn cho mọi nhu cầu
                </span>
                            </div>
                        </div>
                    </ModalContent>
