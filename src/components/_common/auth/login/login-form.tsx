...
export const LoginForm = () => {
    ...
    return (
        ...
        <Form {...form}>
            ...
            <div
                className="form font-normal w-full max-w-xs rounded-md shadow-xl overflow-hidden z-[100] relative snap-start shrink-0 p-8 bg-opacity-80 bg-gray-900 r flex flex-col items-center justify-center gap-3 transition-all duration-300">
