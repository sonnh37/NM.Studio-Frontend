                    ...
                    <div className="relative w-full mt-10 max-w-xl mx-auto">
                        ...
                        {!file && (
                            <motion.div
                                ...
                                className={cn(
                                    "relative cursor-pointer group-hover/file:shadow-2xl z-40 bg-white dark:bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-32 mx-auto rounded-md",
